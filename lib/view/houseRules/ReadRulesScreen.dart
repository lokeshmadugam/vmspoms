...
import '/view/houseRules/ReadSubRulesScreen.dart';
        ...
        if (response.data?.result != null) {
          ...
          if (data != null) {
            setState(() {
              _rulesItems = data;
              count = itemscount;
              if ((_rulesItems != null || _rulesItems.isNotEmpty) &&
                  count != 0) {
                showitems = true;
              } else {
                notshow = true;
                                            ...
                                            Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                      "${item.docPublishDate != null ? DateFormat('yyyy-MM-dd hh:mm a').format(DateTime.parse(item.docPublishDate.toString())) : ''}",
                                                      style: GoogleFonts.roboto(
                                                          textStyle: TextStyle(
                                                              fontSize: 12)))
                                                ],
