...
class _LostFoundTabsScreenState extends State<LostFoundTabsScreen> with SingleTickerProviderStateMixin {
  ...
  Widget _getSelectedScreen() {
    switch (_selectedButton) {
      case 'Lost Items':
        return LostItemsScreen(permisssions: widget.data,);
      case 'Unclaimed Items':
        return UnclaimedItemsScreen(permisssions: widget.data,);
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              child: Text(
                                "Lost Items", softWrap: true, textAlign: TextAlign.center,
                                style:GoogleFonts.roboto(textStyle: TextStyle(fontSize: fontSize, color: _selectedButton == "Lost Items" ? Colors.black : Colors.white)) ,
                              ),
                            ),
                          ),
                          Expanded(
                            child: SizedBox(
                              ...
                              child: ElevatedButton(
                                style: ElevatedButton.styleFrom(
                                    backgroundColor: _selectedButton == 'Unclaimed Items'
                                        ? Colors.white
                                        : Color(0xFF1883BD),
                                    shape: RoundedRectangleBorder(
                                        borderRadius: BorderRadius.only(
                                ...
                                child: Text(
                                  "Unclaimed Items", softWrap: true, textAlign: TextAlign.center,
                                  style:GoogleFonts.roboto(textStyle:  TextStyle(fontSize: fontSize, color: _selectedButton == "Unclaimed Items" ? Colors.black : Colors.white),
                                  )
                                ),
                              ),
                            ),
