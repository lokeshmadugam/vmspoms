...
class SecurityViewDetailsListingsScreen extends StatefulWidget {
  var permisssions;
 SecurityViewDetailsListingsScreen({Key? key,required this.permisssions}) : super(key: key);

  @override
  State<SecurityViewDetailsListingsScreen> createState() => _SecurityViewDetailsListingsScreenState();
}

class _SecurityViewDetailsListingsScreenState extends State<SecurityViewDetailsListingsScreen> {
        ...
        child: Card(
          ...
          child: Column(
            children: [
              ...
              ContainerValue(
                text: "Created On",
                value: ": ${item.checkinTime != null ? DateFormat(
