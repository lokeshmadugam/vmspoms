...
class _SecurityTabsScreenState extends State<SecurityTabsScreen> with SingleTickerProviderStateMixin {
  ...
  Widget _getSelectedScreen() {
    switch (_selectedButton) {
      case 'Security Checks':
        return SecurityChecksScreen(permisssions: permissions,);
      case 'View Details':
        return SecurityViewDetailsListingsScreen(permisssions: permissions,);
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text(
                        "Security Checks",
                        style: GoogleFonts.roboto(textStyle: TextStyle(fontSize: fontSize, color: _selectedButton == "Security Checks" ? Colors.black : Colors.white)),
                      ),
                    ),
                  ),
                  Expanded(
                    child: SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: Text(
                          "View Details",
                          style:GoogleFonts.roboto(textStyle:  TextStyle(fontSize: fontSize,  color: _selectedButton == "View Details" ? Colors.black : Colors.white),
                          )
                          ),
                      ),
                    ),
