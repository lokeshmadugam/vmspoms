...
class _AttendanceTabsScreenState extends State<AttendanceTabsScreen>
  ...
  Widget _getSelectedScreen() {
    switch (_selectedButton) {
      case 'Clock-In/Clock-Out':
        return ClockInClockOutScreen(
          permissions: permissions,
        );
      case 'Attendance':
        return AttendanceListingsScreen(
          permissions: permissions,
        );
                          ...
                          child: ElevatedButton(
                            ...
                            child: Text("Attendance",
                                ...
                                style: GoogleFonts.roboto(
                                  textStyle: TextStyle(
                                    fontSize: fontSize,
                                    color: _selectedButton == "Attendance"
                                        ? Colors.black
                                        : Colors.white,
                                  ),
                                )),
