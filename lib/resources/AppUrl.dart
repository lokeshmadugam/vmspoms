class AppUrl {
  ...
  static var getAllParkings =
      baseUrl + "ParkingLayoutOccupiedAndUnOccupiedByBayType";
  ...
  static var clockInClockOutByEmployeId =
      baseUrl + "ClockInClockOutByEmployeIdAndClockInOutDate";
