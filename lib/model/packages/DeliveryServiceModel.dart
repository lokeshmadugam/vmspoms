class DeliveryServiceModel {
  ...
  DeliveryServiceModel({this.status, this.message, this.result});

  DeliveryServiceModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Items {
  ...
  Items.fromJson(Map<String, dynamic> json) {
    ...
    deliveryServName = json['delivery_serv_name'];
    serviceCountry = json['service_country'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['delivery_serv_name'] = this.deliveryServName;
    data['service_country'] = this.serviceCountry;
