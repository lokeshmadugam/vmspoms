...
class ParkingRepository {
  ...
  // ParkingRepo
  Future<dynamic> getParking(String orderBy,
      String orderByPropertyName, int pageNumber, int pageSize,int propertyId,String unitNo) async {
  ...
  // ParkingTypeRepo
  Future<dynamic> getParkingType(String orderBy,
  ...
  // GetAllParkingsRepo
  Future<dynamic> getAllParkings(String baytype,String orderBy,
      String orderByPropertyName, int pageNumber, int pageSize,int propertyId,) async {
