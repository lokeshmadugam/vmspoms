...
class InviteVisitorRepository {
  ...
  Future<VisitorsStatusModel>  getVisitorStatus(String orderBy,
  ...
  Future<VisitorsListModel> getVisitList(String orderBy,
...
//Favorite Visitor Registrtion
  ...
  // Get Favorite List
  Future<dynamic> getFavoriteVisitorList(String orderBy,
      String orderByPropertyName, int pageNumber, int pageSize,int propertyId,int userId) async {
    String orderby = orderBy;
    String orderByPN= orderByPropertyName;
    String pagenumber = pageNumber.toString();
    String pagesize = pageSize.toString();
